    ...
    */
    ...
    xml_str += " Version=\"" + version.ToString() + "\" MessageID=\"" + MSG_ID.ToString() + "\"" + ">" + "\r\n";
          ...
          try
          {
              ...
              xml_str +="<VendorIdentifier>" + Util.ConvertValueTypeToString(VendorIdentifier, "u32", "") + "</VendorIdentifier>";
          ...
          try
          {
              ...
              xml_str +="<MessageSubtype>" + Util.ConvertValueTypeToString(MessageSubtype, "u8", "") + "</MessageSubtype>";
          ...
          try
          {
              ...
              xml_str +="<Data>" + Util.ConvertArrayTypeToString(Data, "bytesToEnd", "Hex") + "</Data>";
    ...
    xml_str += " Version=\"" + version.ToString() + "\" MessageID=\"" + MSG_ID.ToString() + "\"" + ">" + "\r\n";
          ...
          for(int i=0; i<len;i++)xml_str += Util.Indent(AirProtocolLLRPCapabilities[i].ToString());
          }
